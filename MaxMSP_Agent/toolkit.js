...
function get_patcher_objects(request_id) {
    ...
    // outlet(1, "add_boxtext", JSON.stringify(patcher_dict, null, 2));
	var results = {"request_id": request_id, "results": patcher_dict}
	// outlet(1, "response", JSON.stringify(patcher_dict, null, 2));
	//post(JSON.stringify(results, null, 2))
    // var arr = ["hi hi", "hello", "world !"];
	// outlet(1, "response", JSON.stringify(results, null, 2));
